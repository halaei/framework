...
class JobProcessor
{
     ...
     * @throws \Throwable
     */
    public function process($connectionName, Job $job, WorkerOptions $options)
    {
        try {
     ...
     * @throws \Exception
     */
    protected function handleJobException($connectionName, Job $job, WorkerOptions $options, $e)
    {
        try {
     ...
     * @return void
     */
    protected function markJobAsFailedIfAlreadyExceedsMaxAttempts($connectionName, Job $job, $maxTries)
    {
     ...
     * @return void
     */
    protected function markJobAsFailedIfWillExceedMaxAttempts($connectionName, Job $job, $maxTries, $e)
    {
        $maxTries = ! is_null($job->maxTries()) ? $job->maxTries() : $maxTries;
     ...
     * @return void
     */
    protected function failJob($connectionName, Job $job, $e)
    {
